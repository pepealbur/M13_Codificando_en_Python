...
# ordena la tabla por el campo "Nombre", imprime el número de registros y campos, y guarda el archivo con las modificaciones.
...
try:
    ...
    print("Tabla ordenada por el campo 'Nombre'.")
